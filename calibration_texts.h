...
,
    {
        "AC.STEP_B.TARE_PROCESS", 5, "body",
        {
            "🔄 Processing tare operation...",
            nullptr
        },
        {
            nullptr
...
,
    {
        "AC.STEP_B.SPAN_PROCESS", 6, "body",
        {
            "🔄 Processing span calibration...",
            nullptr
        },
        {
            nullptr
...
,
    {
        "AC.STEP_B.SPAN_COMPUTING", 8, "body",
        {
            "🧮 Computing span coefficients...",
            nullptr
        },
        {
            nullptr
...
,
    {
        "AC.STEP_C.DISABLED_HEADER", 9, "header",
        {
            "==========================================",
            "📋 STEP C: MATRIX CALIBRATION (DISABLED)",
            "==========================================",
...
,
    {
        "AC.STEP_C.DISABLED_INFO", 9, "body",
        {
